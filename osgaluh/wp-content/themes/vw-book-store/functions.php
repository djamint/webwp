...
function vw_book_store_setup() {
	...
	if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'vw-book-store') {
		wp_redirect(admin_url('themes.php?page=vw_book_store_guide'));
	}
}
